...
/* This wasn't there in original code. */
...
static int max98088_probe(struct snd_soc_codec *codec)
{
       ...
       // But, whenever mic bias turns on, 1s mic noise happens.
       // So, I decided that MAXIM codec and mic bias keeps powered on during phone wakes up.
