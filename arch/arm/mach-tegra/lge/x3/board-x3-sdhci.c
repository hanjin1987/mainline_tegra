/*
 * arch/arm/mach-tegra/lge/x3/board-x3-sdhci.c
 *
...
//	tegra_gpio_enable(X3_WLAN_WOW); // Nvidia recommendation
//	irq = gpio_to_irq(X3_WLAN_WOW);
//	set_irq_flags(irq, IRQF_VALID); // Add this line!
//	rc = enable_irq_wake(irq);
//	tegra_gpio_disable(198); // Nvidia recommendation
